...
* Fri Jun 10 2011 Jaromir Capik <jcapik@redhat.com> 3.2.8-22.20110302git
- Fix for #711192 - "Non-standard uts for running kernel" with linux 3.0

* Thu Jun 02 2011 Jan Görig <jgorig@redhat.com> 3.2.8-21.20110302git
- added manual page fix to previous patch

* Wed Jun 01 2011 Jan Görig <jgorig@redhat.com> 3.2.8-20.20110302git
- fix #532668 - procps/top SWAP statistics makes no sense (adapted patch from Mr. Kosaki)

* Thu May 05 2011 Jan Görig <jgorig@redhat.com> 3.2.8-19.20110302git
- #692995 - w - patch from Debian for specifying USER and FROM length

* Wed Mar 03 2011 Jan Görig <jgorig@redhat.com> 3.2.8-18.20110302git
...
* Wed Feb 09 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 3.2.8-17.20110131git
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Mon Jan 31 2011 Jan Görig <jgorig@redhat.com> 3.2.8-16.20110113git
